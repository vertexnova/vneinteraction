...
class VNE_INTERACTION_API OrbitManipulator final : public ICameraManipulator {
   public:
   ...
   private:
    ...
    void dragRotate(float delta_x_px, float delta_y_px, double delta_time) noexcept;
