 ...
 * reminder that the redundant direct includes above may be collapsed to @c interaction_types.h-only in a future **2.0.0**
 * major release; track via CHANGELOG. Not defined by default (no warning for normal apps).
 *
 * @par Usage
