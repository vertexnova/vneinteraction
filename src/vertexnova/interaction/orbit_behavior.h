...
public:
     ...
     */
    void setPivot(const vne::math::Vec3f& pos, CenterOfInterestSpace space
                  = CenterOfInterestSpace::eWorldSpace) noexcept;
    ...
    /** Set mouse button mapping for rotate/pan. */
...
private:
    ...
    void dragPan(float x_px, float y_px, float delta_x_px, float delta_y_px,
