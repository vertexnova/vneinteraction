...
build_cmake_command() {
  cmake -G "Visual Studio 17 2022" -A x64 -DCMAKE_BUILD_TYPE="$BUILD_TYPE" -DVNE_INTERACTION_LIB_TYPE="$LIB_TYPE" -DCMAKE_C_COMPILER=cl -DCMAKE_CXX_COMPILER=cl -DVNE_INTERACTION_TESTS=ON "$PROJECT_ROOT"
}
