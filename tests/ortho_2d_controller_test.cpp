...
TEST(Ortho2DController, DisablePanOrRotationMidGestureEndsManipulatorLatch) {
...

    {
        ...
        ctrl.onEvent(vne::events::MouseButtonReleasedEvent(vne::events::MouseButton::eLeft, 0, 300.0, 260.0), kDt);
    }

    {
        ...
        ctrl.setRotationEnabled(true);
        ctrl.onEvent(vne::events::MouseMovedEvent(256.0, 256.0), kDt);
        ctrl.onEvent(vne::events::MouseButtonPressedEvent(vne::events::MouseButton::eRight, 0, 256.0, 256.0), kDt);
        ...
        ctrl.onEvent(vne::events::MouseButtonReleasedEvent(vne::events::MouseButton::eRight, 0, 280.0, 240.0), kDt);
    }
}
